...
if __name__ == '__main__':
	...
	out_path = os.path.join('/data/ydchen/VLP/bigmodel/IJCAI23/MAE', 'data_temp')
	...
	for i in range(0, 20):
		t1 = time.time()
		gt,tmp_data1,tmp_data2 = iter(data).__next__()
		...
		im_cat = np.concatenate([img_affs,img_data1, img_data2], axis=1)
